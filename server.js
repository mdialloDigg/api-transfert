/******************************************************************
 * APP TRANSFERT – VERSION FINALE STABLE & DESIGN PRÉSERVÉ
 ******************************************************************/
...
button{width:260px;padding:15px;margin:10px;border-radius:8px;border:none;color:white;font-size:16px}
...
.container{max-width:820px;margin:30px auto;background:#fff;padding:25px;border-radius:12px}
.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:15px}
input,select{padding:10px;border-radius:6px;border:1px solid #ccc}
button{width:100%;padding:14px;background:#2eb85c;color:white;border:none;border-radius:8px}
</style>
<div class="container">
...
<input readonly value="${t?.recoveryAmount||''}">
</div>
...
<div class="card">
<b>Code:</b> ${t.code}<br>
<b>Expéditeur:</b> ${t.senderFirstName} ${t.senderLastName}<br>
<b>Destinataire:</b> ${t.receiverFirstName} ${t.receiverLastName}<br>
...
app.listen(PORT,'0.0.0.0',()=>console.log('🚀 Serveur lancé',PORT));
